...
assert() {
  ...
  echo "$input" | ./target/debug/qcc -o tmp.s
...
assert 1 'int main() { int a=5; int z=4; a-z; }'
assert 15 'int main() { int a=3; int z=5; return a*z; }'
assert 2 'int main() { int a=8; int z=4; a/z; }'
...
assert 2 'int main() { int x=3; int y=5; int z=1; return &x-&z; }'
...
assert 5 'int x; int main() { x=2; int y=3; return x+y ; }'
