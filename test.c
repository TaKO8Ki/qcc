...
int main()
{
    ...
    assert(7, ({ int x=3; int y=5; *(&y-2+1)=7; x; }), "int x=3; int y=5; *(&y-2+1)=7; x;");
    assert(2, ({ int x=1; int y=1; int z=1; return &z-&x; }), "int x=1; int y=1; int z=1; return &z-&x;");
    assert(5, ({ int x=3; return (&x+2)-&x+3; }), "int x=3; return (&x+2)-&x+3;");
    ...
    assert(3, ({ int x[3]; *x=3; *(x+1)=4; *(x+2)=5; *x; }), "int x[3]; *x=3; *(x+1)=4; *(x+2)=5; return *x;");
    assert(4, ({ int x[3]; *x=3; *(x+1)=4; *(x+2)=5; *(x+1); }), "int x[3]; *x=3; *(x+1)=4; *(x+2)=5; return *(x+1);");
    assert(5, ({ int x[3]; *x=3; *(x+1)=4; *(x+2)=5; *(x+2); }), "int x[3]; *x=3; *(x+1)=4; *(x+2)=5; return *(x+2);");
    ...
    assert(3, ({ int x[3]; *x=3; x[1]=4; x[2]=5; x[0]; }), "int x[3]; *x=3; x[1]=4; x[2]=5; x[0];");
    ...
    assert(1, ({ char x=1; return x; }), "char x=1; return x;");
    assert(1, ({ char x=1; char y=2; return x; }), "char x=1; char y=2; return x;");
    assert(2, ({ char x=1; char y=2; return y; }), "char x=1; char y=2; return y;");
    ...
    assert(165, ({ "\xA5"[0]; }), "\"\xA5\"[0];");
    assert(255, ({ "\x00ff"[0]; }), "\"\x00ff\"[0];");
